...
<div class="container">
    <h1>修改博客</h1>
    <hr/>
    <form:form action="/admin/blogs/updateB" method="post" commandName="blogU" role="form">
        <div class="form-group">
            <label for="title">标题：</label>
            <input type="text" class="form-control" id="title" name="title" placeholder="请输入博客标题" value="${blog.title}"/>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" id="content" name="content" rows="3"
                      placeholder="请输入博客内容">${blog.content}</textarea>
        </div>
        <div class="form-group">
            <label for="pubDate">发布时间：</label>
            <input type="date" class="form-control" id="pubDate" name="pubDate"
                   value="<fmt:formatDate value="${blog.pubDate}" pattern="yyyy-MM-dd HH:mm:ss"/>"/>
        </div>
        <!-- 把 id 一并写入 blogU 中 -->
